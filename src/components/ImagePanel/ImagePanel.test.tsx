...
describe('Image Panel', () => {
  ...
  describe('Image height', () => {
    ...
    describe('Image height updates', () => {
      ...
      it('Should update image height if panel size changed', async () => {
        ...
        expect(screen.getByTestId(TestIds.panel.image)).toHaveAttribute('height', (300 - 123).toString());
      });
  ...
  describe('Toolbar', () => {
    ...
    it('Should show pan pinch zoom controls for image', () => {
      ...
      expect(screen.getByTestId(TestIds.panel.zoomPanPinchControls)).toBeInTheDocument();
    });
